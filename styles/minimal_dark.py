...
style = {  # REMEMBER TO USE THIS WITH A CHART LENGTH OF 180
    ...
    'indicators': {  # noqa
        ...
        'triggers': [  # noqa
            ...
            {'type': 'cross_filter', 'crossup': '_ema_9_point_trig_up', 'crossdown': '_ema_9_point_trig_down', 'limit': 5},
            ...
            {'type': 'cross_filter', 'crossup': '_ema_26_point_trig_up', 'crossdown': '_ema_26_point_trig_down', 'limit': 5},
    ...
    'ticker': {
        'style': {
            ...
            'colorup': '#2eff62',
            'colordown': '#ff2e2e',
            'tickerfont': 'Arial 7 normal bold',
            'tickerfontcolorup': 'white',
            'tickerfontcolordown': 'white',
            'tickerbgup': 'black',
            'tickerbgdown': 'black',
            'quotefont': 'Arial 7 normal bold',
