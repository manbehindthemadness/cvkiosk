...
class Layout(gp.Diagram):
    ...
    def __init__(self, parent: tk.Frame, cache: gp.ImgCache, settings: config):
        ...
        self.points1_invalid = gp.PointAlert(self, cache)
        self.points2_invalid = gp.PointAlert(self, cache)
        self.points3_invalid = gp.PointAlert(self, cache)
        self.points4_invalid = gp.PointAlert(self, cache)
